(function (global, factory) {
  ...
  function tmpl(o) {
    ...
    return this.replace(/\${([^{}]*)}/g, (a, b) => _arguments[b]);
  }
  ...
  const _ = function _(name, validator) {
    validator.name = name;
  ...
  _('pattern', { fn: function fn(val, pattern) {
    const m = pattern.match(new RegExp('^/(.*?)/([gimy]*)$'));return !val || new RegExp(m[1], m[2]).test(val);
  } });
  _('equals', { fn: function fn(val, otherFieldSelector) {
    const other = document.querySelector(otherFieldSelector);return other && (!val && !other.value || other.value === val);
  } });
